# Hardware configuration template for Intel NUC8i3BEH (BOXNUC8i3BEH1)
#
# How to use:
#   cp hardware/template-nuc8i3beh.nix hardware/media-node-1.nix
#   # Edit the file — at minimum set the correct wired interface name.
#
# After first deploy you can regenerate this properly with:
